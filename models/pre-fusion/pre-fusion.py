...
modalities = ['CDIT' , 'DIT','CDT','CIT','CDI','CD', 'CI', 'CT', 'DI', 'DT', 'IT','C' , 'D', 'I', 'T']
...
for mod in modalities:
    ...
    model.fit(trainimages, trainlabels, validation_data=(testimages, testlabels) , epochs=3, batch_size=100)
