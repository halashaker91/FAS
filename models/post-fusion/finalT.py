...
for mod in modalities:   
    ...
    model.add(tf.keras.layers.Dense(160, activation='tanh'))
    ...
    model.fit(trainimages, trainlabels, validation_data=(testimages, testlabels) , epochs=6, batch_size=92)
